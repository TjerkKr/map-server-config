...
cp ./nginx/map.freifunk-flenburg.de.conf /etc/nginx/sites-available/
ln -s /etc/nginx/sites-available/map.freifunk-flenburg.de.conf /etc/nginx/sites-enabled/map.freifunk-flenburg.de.conf
